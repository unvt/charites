...
export const writeYaml = (destinationPath: string, style: StyleSpecification, composite=false) => {
    if (composite === true) {
...
const writeCompositedYaml = (destinationPath: string, style: StyleSpecification) => {
...
const writeDecompositedYaml = (destinationPath: string, style: StyleSpecification) => {
